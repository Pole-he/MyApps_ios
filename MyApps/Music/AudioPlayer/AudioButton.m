...
NSString *playImage = @"icon_music_circle_play";
NSString *stopImage = @"icon_music_circle_pause";
...
- (void)startSpin
{
    if (!loadingView) {
        ...
        loadingView.image = [UIImage imageNamed:@"icon_online_music_loading"];
...
- (void)selectSpin:(NSInteger)index
{
    self.num = index;
}
- (void)resetSpin
...
- (void)stopSpin
{
    ...
    [self setColourR:0.26 G:0.72 B:0.9 A:1.0];
}
